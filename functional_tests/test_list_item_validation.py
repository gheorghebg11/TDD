...
class ItemValidationTest(FunctionalTest):    
    def test_cannot_add_empty_list_items(self):
        ...
        self.broswer.find_element_by_id('id_new_item').send_keys('Buy photo album\n')
        self.check_for_row_in_list_table('1: Buy photo album')

        # She tries to submit an empty message again
        self.broswer.find_element_by_id('id_new_item').send_keys('\n')
        ...
        self.broswer.find_element_by_id('id_new_item').send_keys('Buy another photo album\n')
        self.check_for_row_in_list_table('1: Buy photo album')
